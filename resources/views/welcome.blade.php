...
<head>
    ...
    <link href="{{URL::asset('public/FontEnd/css/bootstrap.min.css')}}" rel="stylesheet">  <!--dấu ngoặc nhọn chỉ đg dẫn tuyệt đối-->
    <link href="{{URL::asset('public/FontEnd/css/font-awesome.min.css')}}" rel="stylesheet">
    <link href="{{URL::asset('public/FontEnd/css/prettyPhoto.css')}}" rel="stylesheet">
    <link href="{{URL::asset('public/FontEnd/css/price-range.css')}}" rel="stylesheet">
    <link href="{{URL::asset('public/FontEnd/css/animate.css')}}" rel="stylesheet">
	<link href="{{URL::asset('public/FontEnd/css/main.css')}}" rel="stylesheet">
	<link href="{{URL::asset('public/FontEnd/css/responsive.css')}}" rel="stylesheet">
...
<body>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.php"><img src="{{('public/FontEnd/images/logo.png')}}" alt="" /></a>
						</div>
	...
	<section>
		<div class="container">
			<div class="row">
				...
				@yield('content') <!--lien ket voi home.blade.php cua section-->
				</div>
			</div>
		</div>
	</section>
    ...
    <script src="{{URL::asset('public/FontEnd/js/jquery.js')}}"></script>
	<script src="{{URL::asset('public/FontEnd/js/bootstrap.min.js')}}"></script>
	<script src="{{URL::asset('public/FontEnd/js/jquery.scrollUp.min.js')}}"></script>
	<script src="{{URL::asset('public/FontEnd/js/price-range.js')}}"></script>
    <script src="{{URL::asset('public/FontEnd/js/jquery.prettyPhoto.js')}}"></script>
    <script src="{{URL::asset('public/FontEnd/js/main.js')}}"></script>
</body>
</html>